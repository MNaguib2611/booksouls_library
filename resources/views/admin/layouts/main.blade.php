        ...
        <div class="app-header header-shadow">
            <div class="app-header__logo">
                ...
                <a class="navbar-brand" href="/">
                    <img src="{{asset('imgs/LogoMakr_0kpqd2.png')}}" alt="Logo" style="width:180px;height:75px;margin-top:5px;">
                </a>
                                ...
                                <div class="widget-content-left">
                                    <div class="btn-group">
                                        <a data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                                            class="p-0 btn">
                                            <img width="42" class="rounded-circle" src="{{Auth::user()->avatar}}"
                                                alt="">
                                        ...
                                        <div tabindex="-1" role="menu" aria-hidden="true"
                                            ...
                                            <button type="button" tabindex="0" class="dropdown-item"
                                                onclick="window.location.href ='{{route('admins.show',Auth::id())}}'"
                                            >Profile</button>
                ...
                <div class="scrollbar-sidebar">
                    <div class="app-sidebar__inner">
                        <ul class="vertical-nav-menu mb-5">
                            ...
                            <li class="app-sidebar__heading">Leases</li>
                            <li>
                    ...
                    <div class="app-footer">
                        <div class="app-footer__inner text-center">
                            <div class="text-center m-auto">
                                <ul class="nav">
                                    <li class="nav-item">
                                        <a href="https://github.com/MNaguib2611/booksouls_library" class="nav-link">
                                            <strong> All rights reserved. copyright © 2020</strong>
                                        </a>
                                    </li>
