...
@section('content')
    ...
    <form class="form-horizontal text-center" role="form" method="get" action="/selectedData"  enctype="multipart/form-data">
        @csrf
        <button type="submit" class="btn btn-primary mr-5 float-right">Filter Data</button>
        <input type="search" name="search" id="search" class="form-control float-right mr-2" aria-label="Search" placeholder="Search" style="width:20%" />
        <select class="form-control custom-select float-right mr-2" name="order" value="title" style="width:max-content;">
            <option value="0" class="bg-light" disabled="disabled" selected>Sort by</option>
            <option value="title">Sort by Title</option>
            <option value="avgRate">Sort by Rate</option>
            <option value="created_at">Sort by Latest</option>
        </select>

        <select class="form-control custom-select float-right mr-2" name="category" style="width:max-content;">
            <option value="0" class="bg-light" disabled="disabled" selected="selected">Filter by Category</option>
